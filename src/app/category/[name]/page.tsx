...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `Comprar ${decodedName} Kawaii | Indigo Store`,
    description: `Descubre los mejores productos y accesorios en la categoría ${decodedName} de Indigo Store. ¡Envíos en Venezuela! ✨`,
  };
}
